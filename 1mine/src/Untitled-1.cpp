...
double pr_mean_beta, pr_sd_beta, pr_a_th_sigma, pr_b_th_sigma, pr_mean_theta;
double pr_a_sigma, pr_b_sigma, pr_mean_gamma, pr_sd_gamma;

double missing;

////////////////////////////////////////////////////////////////////////////////

const int nsample = data.rows();
const int nitem = data.cols();
...
VectorXd oldbeta(nitem, fill::randu);
